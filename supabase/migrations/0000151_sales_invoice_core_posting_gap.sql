...
-- Source:
--   20260525083000_add_sales_invoice_engine.sql
-- Included:
...
--   - prevent_negative_inventory_stock
--   - inventory negative stock triggers
-- Reason:
--   Those are already packaged in 000012_inventory_item_master_engine.sql.
-- Rule:
