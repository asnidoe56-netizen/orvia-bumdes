...
export function PageBackButton({
  ...
  return (
    <div className="h-14 print:hidden">
      <div className="fixed left-4 right-4 top-20 z-30 flex pointer-events-none lg:left-[19rem]">
        <button
          type="button"
          onClick={handleBack}
          className="group pointer-events-auto inline-flex w-fit items-center gap-2 rounded-full border border-emerald-200 bg-white/95 px-3 py-2 text-sm font-bold text-emerald-800 shadow-lg shadow-slate-200/70 backdrop-blur transition hover:-translate-y-0.5 hover:border-emerald-300 hover:bg-emerald-600 hover:text-white hover:shadow-xl sm:px-4 sm:py-2.5"
        >
