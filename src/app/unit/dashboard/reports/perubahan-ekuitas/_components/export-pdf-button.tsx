...
import {
  exportPerubahanEkuitasPdf,
  type PerubahanEkuitasPdfData,
} from "@/lib/reports/perubahan-ekuitas-pdf";

type ExportPdfButtonProps = {
  fileName?: string;
  reportData: PerubahanEkuitasPdfData;
};
...
export function ExportPdfButton({
  ...
  async function handleExportPdf() {
    ...
    try {
      await exportPerubahanEkuitasPdf({
        data: reportData,
        fileName,
      });
    } catch (error) {
