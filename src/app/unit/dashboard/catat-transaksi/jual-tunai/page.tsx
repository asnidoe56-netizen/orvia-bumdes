    ...
    <div className="space-y-5">
        ...
        <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
          <div>
            ...
            <p className="mt-1 max-w-3xl text-sm leading-6 text-slate-600">
              Fondasi halaman penjualan tunai sudah tersedia. Form transaksi
              akan dihubungkan setelah engine penjualan tunai diverifikasi dari
              database.
            </p>
          </div>
      ...
      <section className="rounded-3xl border border-dashed border-slate-300 bg-slate-50 p-6">
        ...
        <p className="mt-2 max-w-3xl text-sm leading-6 text-slate-600">
          ...
          dan tanggal transaksi. Backend akan menangani stok keluar, kas masuk,
          pendapatan, harga pokok, dan pencatatan keuangan.
        </p>
      </section>
    </div>
  );
