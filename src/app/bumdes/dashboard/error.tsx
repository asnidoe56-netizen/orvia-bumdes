...
// Tanpa file ini, error server apa pun di dashboard BUMDes jatuh ke layar hitam
// bawaan Next.js ("This page couldn't load") tanpa konteks. Digest tetap
// ditampilkan supaya baris log di VPS bisa dicocokkan.

import { useEffect } from "react";
import { AlertTriangle, RotateCcw } from "lucide-react";

export default function BumdesDashboardError({
  error,
  unstable_retry,
}: {
  ...
  useEffect(() => {
    console.error("[bumdes/dashboard]", error);
  }, [error]);
